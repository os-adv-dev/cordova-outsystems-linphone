...
- (NSString *)displayName {
	...
	if (_person) {
		...
		NSString *lLocalizedFirstName = lFirstName;//[FastAddressBook localizedLabel:lFirstName];
		NSString *compositeName = _person.nickname;
		NSString *lLastName = _person.familyName;
		NSString *lLocalizedLastName = lLastName;//[FastAddressBook localizedLabel:lLastName];
		NSString *lOrganization = _person.organizationName;
		NSString *lLocalizedOrganization = lOrganization;//[FastAddressBook localizedLabel:lOrganization];
